 ...
 * @data 2019/1/2
 */
public class DomeActivity4 extends BaseActivity {
...
public static DomeActivity4 instance = null;
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    mTvDomeTitle.setText(R.string.string_title4);
    instance = this;
}
...
public void onViewClicked(View view) {
    switch (view.getId()) {
        case R.id.btn1_dome:
            ...
            break;
        case R.id.bt2_dome:
            goToActivity(mActivity,DomeActivity5.class);
            break;
        case R.id.btn3_dome:
            break;
        case R.id.btn4_dome:
