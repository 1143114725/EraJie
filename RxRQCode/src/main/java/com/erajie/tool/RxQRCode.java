...
public class RxQRCode {
    ...
    public static class Builder {
        ...
        public Bitmap into(String string,Context context,ImageView imageView) {
            Bitmap bitmap = RxQRCode.creatQRCode(content, codeSide, codeSide, backgroundColor, codeColor);
     ...
     * @return
     */
    public static String saveBitmap(Context context, Bitmap mBitmap, String filename, String filepath) {
        ...
        try {
            filePic = new File(filepath,filename + ".jpg");
            if (!filePic.exists()) {
