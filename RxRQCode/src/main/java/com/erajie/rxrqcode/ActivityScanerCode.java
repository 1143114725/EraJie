...
import com.erajie.rxutils.RxAnimationTool;
import com.erajie.rxutils.RxBarTool;
import com.erajie.rxutils.RxBeepTool;
import com.erajie.rxutils.RxPhotoTool;
import com.erajie.rxutils.view.RxToast;
import com.erajie.scaner.CameraManager;
import com.erajie.scaner.OnRxScanerListener;
import com.erajie.scaner.PlanarYUVLuminanceSource;
import com.erajie.scaner.decoding.InactivityTimer;
import com.erajie.tool.RxQrBarTool;
 ...
 * 自定义扫描二维码页面，可以自己改UI
 * <code>//二维码生成方式一  推荐此方法
 * RxQRCode.builder("二维码生成方式一  推荐此方法").
 * backColor(0xFFFFFFFF).
 * codeColor(0xFF000000).
 * codeSide(600).
 * into(mImgDomeCode);
 * RxToast.success("二维码已生成!");</code>
 * <code>//条形码生成方式一  推荐此方法
 * RxBarCode.builder("95685468").
 * backColor(0x00000000).
 * codeColor(0xFF000000).
 * codeWidth(1000).
 * codeHeight(300).
 * into(mImgDomeCode);
 * RxToast.success("条形码已生成!");</code>
 */
...
//    private RxDialogSure rxDialogSure;
	...
	private void initDialogResult(Result result) {
		...
		intent.putExtra("realContent", realContent);
